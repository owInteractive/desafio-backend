...
class TransactionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\Transaction::create(['user_id' => 1, 'transaction_type_id' => 3, 'value' => 100]);
        \App\Models\Transaction::create(['user_id' => 1, 'transaction_type_id' => 1, 'value' => 500]);
        \App\Models\Transaction::create(['user_id' => 1, 'transaction_type_id' => 2, 'value' => 100]);
    }
}
